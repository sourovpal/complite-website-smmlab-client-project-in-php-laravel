...
Route::namespace('Admin')->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::middleware('admin')->group(function () {
        ...
        Route::get('orders/pending', 'OrderController@pendingOrder')->name('orders.pending');
        Route::get('orders/processing', 'OrderController@processingOrder')->name('orders.processing');
        Route::get('orders/completed', 'OrderController@completedOrder')->name('orders.completed');
        Route::get('orders/cancelled', 'OrderController@cancelledOrder')->name('orders.cancelled');
        Route::get('orders/refunded', 'OrderController@refundedOrder')->name('orders.refunded');
...
Route::name('user.')->prefix('user')->group(function () {
    Route::middleware('auth')->group(function () {
        ...
        Route::middleware(['checkStatus'])->group(function () {
            ...
            //Order
            Route::post('/order/{category}/{service}', 'OrderController@order')->name('order');
            ...
            Route::get('/order/completed', 'OrderController@orderCompleted')->name('order.completed');
            Route::get('/order/cancelled', 'OrderController@orderCancelled')->name('order.cancelled');
            Route::get('/order/refunded', 'OrderController@orderRefunded')->name('order.refunded');
            Route::get('/order/mass-order', 'OrderController@massOrder')->name('mass.order');
            Route::post('/order/mass-order', 'OrderController@massOrderStore')->name('mass.order');
